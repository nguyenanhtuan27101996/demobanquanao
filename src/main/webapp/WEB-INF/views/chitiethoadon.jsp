	...
	<div class="page-container">
		...
		<div class="left-content container">
			<div class="row" style="margin-left: 20px;">
				...
				<div class="col-md-12">
					<table id="table-chitiethoadon" class="table">
						<thead>
							<th>Mã hóa đơn</th>
						...
						<tbody>
							<c:forEach var="chiTietHoaDon" items="${listChiTietHoaDon }">
								<tr>
									<td>${chiTietHoaDon.getChiTietHoaDonId().getMaHoaDon() }</td>
									<td>${chiTietHoaDon.getChiTietHoaDonId().getMaChiTietSanPham() }</td>
